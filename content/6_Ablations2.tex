...
As detailed in Section \ref{sec:document_collection}, we utilize density-based sampling to ensure the diversity of our document set. To verify the effectiveness, we compared this method against two baselines for selecting SFT samples:
