...
\includegraphics[width=0.86\linewidth]{source/intro.pdf}
    \caption{An illustration of humans iteratively refining instructions for higher complexity to better align with preference.}
    \label{fig: intro}
\end{figure}
...
\begin{itemize}[leftmargin=4mm]
    ...
    \item We release \textbf{DIR-10K}, a high-quality complex instruction dataset curated via our framework that aligns better with real-world requirements. 
    ...
    \item Empirical results demonstrate that our fine-tuned models significantly outperform existing methods across multiple instruction-following benchmarks.
\end{itemize}